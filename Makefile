...
help:
	...
	@echo "  make sync-deps          - Sync Poetry deps to PEP-621 format"
	@echo "  make sync-deps-check    - Check if dependencies are in sync"
	@echo "  make sync-deps-dry-run  - Preview sync changes (dry-run)"
